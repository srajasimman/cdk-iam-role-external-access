...
export function createPartnerIntegrationStack(app: cdk.App): CrossAccountAccessStack {
  return new CrossAccountAccessStack(app, 'PartnerIntegrationStack', {
    ...
    roleDescription: 'Cross-account access for partner data processing and analytics',
    allowedS3Actions: [
      's3:GetObject',
      's3:ListBucket',
      's3:GetObjectVersion',
...
export function createVendorAnalyticsStack(app: cdk.App): CrossAccountAccessStack {
...
export function createCustomerDataExportStack(app: cdk.App): CrossAccountAccessStack {
...
export function getStackConfiguration(stackType: 'partner' | 'vendor' | 'customer' | 'dev'): any {
