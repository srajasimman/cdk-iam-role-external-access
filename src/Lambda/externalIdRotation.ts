...
export const handler: Handler<RotationEvent, RotationResponse> = async (
    ...
    const { SecretId: secretArn, ClientRequestToken: token, Step: step, PreviousVersionId } = event;
...
async function createSecret(
    ...
    const newSecretValue = JSON.stringify({ externalId: newExternalId } as SecretData);
